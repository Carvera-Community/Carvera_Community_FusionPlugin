...
```shell
python3 Tests/UI/run_ui_tests.py verify UI-GCODE-001 /path/to/result.cnc
```

The verifier streams the artifact and requires both the exact `Y-90`
retraction and a following A-axis rotation move.
